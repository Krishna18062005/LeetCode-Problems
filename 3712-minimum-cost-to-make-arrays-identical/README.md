<h2><a href="https://leetcode.com/problems/minimum-cost-to-make-arrays-identical">3712. Minimum Cost to Make Arrays Identical</a></h2><h3>Medium</h3><hr><p>You are given two integer arrays <code>arr</code> and <code>brr</code> of length <code>n</code>, and an integer <code>k</code>. You can perform the following operations on <code>arr</code> <em>any</em> number of times:</p>
